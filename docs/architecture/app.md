...
- корневые providers, если они действительно нужны всему приложению;
...
## Когда нужен provider на уровне app

Только если его значение действительно живёт столько же, сколько всё приложение.

Если provider нужен только редактору поста, он должен находиться рядом с редактором, а не в `app`.
